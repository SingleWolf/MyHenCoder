package com.example.walker.myhencoder.demo.gift.view.page;
...
import static com.example.walker.myhencoder.demo.gift.view.UtilKt.dp2px;
...
public class PageIndicatorView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        dotSize =dp2px(context, dotSize);
        margins =dp2px(context, margins);
    }
